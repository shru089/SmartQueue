...
class Queue(Base):
    ...
    name = Column(String, default="City Medical Center")
    location = Column(String, default="Main Wing, Floor 1")
    ...
    currently_serving = Column(String, nullable=True)

class Token(Base):
    __tablename__ = "tokens"
    id = Column(String, primary_key=True, index=True) # UUID
    token_number = Column(String, index=True) # A001
    ...
    status = Column(String, default="WAITING") # WAITING, CALLED, COMPLETED, CANCELLED, NO_SHOW
